...
/**
 * @defgroup sleep_fns
 * @brief Pause the CPU, putting it in an idle state for a milliseconds/microseconds amount of time.
 *
...
/**
 * @degroup timer_fns
 * @brief Start a non-sleeping timer with timer_poll_start(). Whether the milliseconds amount of time argument
